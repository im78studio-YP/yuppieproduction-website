(function(){
 ...
 section.id='assetAdvancedPositionSection';
 ...
 detail.id='assetAdvancedStructureSection';document.getElementById('assetAppearanceOptions').closest('section').id='assetSurfaceSection';
 const style=document.createElement('style');style.textContent='#mAssetSettings input[aria-invalid=true]{border-color:#ff6b7c;box-shadow:0 0 0 1px #ff6b7c}#mAssetSettings input[data-pending=true]{border-color:#f5ba53}#assetValueStatus{min-height:18px;text-align:left}#assetValueStatus[data-error=true]{color:#ff8b98}#assetNumericDetails{grid-template-columns:repeat(2,minmax(0,1fr))}#assetLegacySizeSection{display:none!important}#mAssetSettings[data-settings-mode=surface] #assetAdvancedPositionSection,#mAssetSettings[data-settings-mode=surface] #assetAdvancedStructureSection,#mAssetSettings[data-settings-mode=surface] #assetAttachmentSection,#mAssetSettings[data-settings-mode=advanced] #assetSettingsName,#mAssetSettings[data-settings-mode=advanced] label[for=assetSettingsName],#mAssetSettings[data-settings-mode=advanced] #assetSurfaceSection{display:none!important}';document.head.append(style);
