(function(){
  ...
  function snapshot(id,options={}){
    ...
    if(id==='corner-luminous-beauty')Object.assign(out.spec,{tileTextureMode:'custom',tileTextureActiveId:'beauty-charcoal-floor',tileTextureId:1,tileTextureUploads:[{id:'beauty-charcoal-floor',name:'Luminous Beauty · พื้นเทาเข้ม',data:YPCornerBeauty.floor}]});
