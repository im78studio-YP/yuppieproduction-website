(function(root){
 ...
 <small>แกนอิงทิศบูธ ไม่ใช่มุมกล้อง · ใช้แกนเดียวกับปรับตำแหน่ง<br>สีชมพูโปร่งใส = สำเนาที่จะสร้าง · ขอบวัดจากกรอบครอบวัตถุตามแกนบูธ รวมการหมุนและ Scale<br>สำเนาปลดจุดยึดเดิม · วางซ้อน/นอกบูธได้ · Undo ครั้งเดียวทั้งชุด</small>
