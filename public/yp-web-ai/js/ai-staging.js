(function initAIStagingContext(global) {
  ...
  function buildAutoStagingPromptLines(options = {}) {
    ...
    if (selectedAssetCount === 0) {
      lines.push('เมื่อไม่มีอุปกรณ์ที่ลูกค้าเลือก ให้สร้างภาพเป็นบูธที่เปิดใช้งานจริงด้วย Auto-Staging ที่ได้รับอนุญาต โดยต้องรักษา Geometry พิกัด สัดส่วน และมุมกล้องจากแบบ 3 มิติเดิมอย่างเคร่งครัด');
    } else {
