(function(){
 ...
 const library=type=>({inline:YPInlineTemplates,corner:YPCornerTemplates,penin:YPPeninsularTemplates,island:YPIslandTemplates,backdrop:YPPhotoBackdropTemplates,photo360:YPPhoto360Templates}[type]);
 const bridge=type=>({inline:YPInlineTemplateBridge,corner:YPCornerTemplateBridge,penin:YPPeninsularTemplateBridge,island:YPIslandTemplateBridge,backdrop:YPPhotoBackdropTemplateBridge,photo360:YPPhoto360TemplateBridge}[type]);
 const template=()=>library(quickSetupDraft.boothType)?.templates.find(t=>t.id===selected);
 const imageFor=t=>'assets/'+({inline:'inline',corner:'corner',penin:'peninsular',island:'island',backdrop:'photo-backdrop',photo360:'photo360'}[quickSetupDraft.boothType])+'-templates/'+t.id+(quickSetupDraft.boothType==='corner'?'-'+quickSetupDraft.cornerSide:'')+'.png';
