(function(root){
 ...
 root.YPPeninsularBotanicalTemplates=[{id:'penin-botanical-atelier',name:'18 · Botanical Atelier',width:6,depth:3,height:3.5,logoScale:0,logoU:3,logoY:3,customBack:true,
  ...
  objects:[
   ...
   {...art('botanical-portrait',5.910,1.18,1.45,1.94,.67,90),tv:'portrait-display'},logo(5.914,1.18,1.48,.42,2.83,90),
   ...[1.15,1.64,2.12].map(y=>({...box(5.918,1.18,.008,1.46,.008,'#57594a',y),tv:'portrait-display'})),{...box(5.918,1.18,.008,.008,1.94,'#57594a',.67),tv:'portrait-display'},
