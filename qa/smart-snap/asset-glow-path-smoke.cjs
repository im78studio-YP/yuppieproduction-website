...
try{for(const mobile of [false,true]){
 ...
 const open=async()=>{await page.evaluate(()=>openAssetSettings());await page.locator('.asset-parts-dialog canvas').waitFor();await page.locator('#assetPickMode').selectOption('part');await page.locator('#assetPartList').selectOption('1');};
