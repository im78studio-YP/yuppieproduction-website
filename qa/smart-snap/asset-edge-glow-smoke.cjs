...
try{for(const mobile of [false,true]){
 ...
 await page.locator('#assetEditParts').click();await page.locator('.asset-parts-dialog canvas').waitFor();
 ...
 await page.locator('#assetEditParts').click();await page.locator('.asset-parts-dialog canvas').waitFor();await page.locator('#assetPartList').selectOption('1');assert.equal(await page.locator('#assetPartGlow').isChecked(),true);
 ...
 await page.locator('#assetEditParts').click();await page.locator('.asset-parts-dialog canvas').waitFor();await page.locator('#assetPartList').selectOption('1');await page.locator('#assetPartGlow').uncheck();await page.locator('[data-part-save]').click();
