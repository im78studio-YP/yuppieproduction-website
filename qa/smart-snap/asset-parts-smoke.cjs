...
(async()=>{
 ...
 try{for(const mobile of [false,true]){
  ...
  await page.locator('#assetEditParts').click();await page.locator('.asset-parts-dialog canvas').waitFor();await page.keyboard.press('Escape');
  ...
  await page.locator('#assetEditParts').click();await page.locator('.asset-parts-dialog canvas').waitFor();await page.locator('#assetPartList').selectOption('1');
